...
##### T2: マルチトラック再生エンジン ✅
- [x] T2-1: MultiTrackAudioSource基礎
  - [x] 複数トラック合成
  - [x] トラックボリューム/パン適用
- [x] T2-2: クリップミキシング
  - [x] 複数クリップの同時再生
...
##### T3: タイムラインUI + クリップ編集 ✅
- [x] T3-1: TimelinePanel（トラックヘッダ + クリップ領域）
  - [x] トラックヘッダ表示（名前、Mute/Solo/Arm、ボリューム）
  - [x] クリップ領域描画
  - [x] タイムラインルーラー（バー/時間表示）
  - [x] プレイヘッド
- [x] T3-2: クリップ波形表示
  - [x] AudioThumbnailCache統合
  - [x] サムネイル描画
- [x] T3-3: ドラッグ移動
  - [x] クリップ選択
  - [x] ドラッグ＆ドロップ移動
...
##### T4: ミキサーUI + トラックFX 🔄
- [x] T4-1: MixerPanel（縦フェーダー + パン + Mute/Solo）
  - [x] チャンネルストリップ
  - [x] フェーダー操作
  - [x] パンノブ
  - [x] M/S/Rボタン
